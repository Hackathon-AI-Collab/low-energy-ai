...
export default function KnowledgeBaseScreen({ ragPipeline }: KnowledgeBaseScreenProps) {
  ...
  const loadDocuments = async () => {
    try {
      const docs = await ragPipeline.getAllDocuments();
      const currentStats = ragPipeline.getStats();
      setDocuments(docs);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statItem}>
          <Text style={styles.statNumber}>{ragPipeline.isModelLoaded() ? '✓' : '✗'}</Text>
